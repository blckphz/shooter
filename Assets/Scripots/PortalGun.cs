...
public class PortalGun : GunSO
{
    ...
    {
        GameObject portalBullet = Object.Instantiate(portalProjectilePrefab, spawnPoint.position, spawnPoint.rotation);
        ...
        Object.Destroy(portalBullet, 5f); // Clean bullet after 5 sec
    }
